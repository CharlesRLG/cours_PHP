...
Session permet de stocker des informations non plus sur l'ordinateur de l'utilisateur,

mais plutot sur un fichier dans notre propre serveur, dans le dossier TMP

Cela nous permet de stocker des informations plus sensibles

Pour lier les informations stocker sur notre serveur à un utilisateur,

un cookie de session est automatiquement créé.

Ce cookie de session, que vous pouvez retrouver dans l'inspecteur dans l'onglet "application",

prends comme valeur une clé généré aléatoirement.
