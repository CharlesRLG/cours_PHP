...
{    
    ...
    echo $message . '<br>Code : '. http_response_code();
    die();
}

function afficherFormulaire() 
{    
    header('Loation: formulaire.html');
    die();
}
...
if(!is_array($appareils))
{
    ...
    formulaireNonValide('Valeur appareil incorrecte');
}
...
echo 'Mdp2 = ' . filter_var($mdp1,FILTER_SANITIZE_FULL_SPECIAL_CHARS) . '<br>' . "\n";
